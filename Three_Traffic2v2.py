...
class TrafficLightController:
    def __init__(self, host: str, port: int, client_id: str =None):
        ...
        self.config = {
            "client_id": client_id or f"traffic_light_{int(time.time())}",
            "direction_names": {
                "A": "เหนือ",
                "B": "ตะวันออก",
                "C": "ใต้"
...
def main():
    ...
    PORT = 5000
    CLIENT_ID = "raspberrtpi3v2"  # สามารถกำหนด ID ตามต้องการ
    
    controller = TrafficLightController(HOST, PORT, CLIENT_ID)
